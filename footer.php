    ...
    <div class="contenair-footer">
        <section class="information-1">
            <div class="section-1">
                ...
                <a href="">Notre espace presse</a>
            </div>
            <div class="section-1">
                <h3>NOS APPLICATIONS</h3>
                <p>Découvrez nos applications</p>
                <div class="logo-store">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-android2" viewBox="0 0 16 16">
            ...
            <div class="section-1">
                ...
                <a href="mon_compte.php">Accès client</a>
                <a href="mon_compte.php">Mes annonces sur Tropical-IMMO</a>
            </div>
            <div class="section-1">
                <h3>À DÉCOUVRIR</h3>
                <a href="">Tout l'immobilier</a>
                <a href="">Toutes les villes</a>
                <a href="">Toutes les provinces</a>
            </div>
        </section>
    </div>
</body>
